...
const LEVEL_INCOME_READ_ABI = [
  // Solidity's autogenerated getter for this struct returns only the
  // non-array member. The 10 uint16 rates are read from storage slot 12.
...
// Deployed ORBI WORLD storage layout (from the compiler storage-layout data):
// s_levelConfig starts at slot 12. The fixed uint16[10] array occupies
// slot 12 (20 bytes packed); levelIncomeEnabled is at slot 13.
...
export default function Dashboard() {
  ...
  const loadLevelIncome = useCallback(async (userId: bigint) => {
    ...
    try {
      ...
      // s_levelConfig() exposes only levelIncomeEnabled because Solidity does
      // not include the fixed array member in the autogenerated struct getter.
      // Read the packed uint16[10] directly from its documented storage slot.
